...
public class Contact_us_2_Pos {
        ...
        for(int a=1;a<10;a++)
    {
        ...
        driver.findElement(By.id("input_5_1")).sendKeys("Zartaj");
        //LastName
        driver.findElement(By.id("field_5_2")).click();
        driver.findElement(By.id("input_5_2")).sendKeys("Jamil");
        //DOB
        driver.findElement(By.id("input_5_20")).sendKeys("31081997");
        //Contact Number
        driver.findElement(By.xpath("//li[@id='field_5_4']")).click();
        driver.findElement(By.id("input_5_4")).sendKeys("1234567890");
