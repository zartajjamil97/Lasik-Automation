 ...
 * @author staff
 */
public class AddCalanderNeg {
    
    //**************************************  ADD NEGITIVE CALANDER    ***************************************//
    ...
    //FirstName
        ...
        driver.findElement(By.id("input_3_1")).sendKeys("zartajcv#$");
        //LastName
        driver.findElement(By.id("field_3_2")).click();
        driver.findElement(By.id("input_3_2")).sendKeys("jami7$l");
        //DOB
        driver.findElement(By.id("input_3_21")).sendKeys("31081997");
        //Contact Number
        driver.findElement(By.id("field_3_4")).click();
        driver.findElement(By.id("input_3_4")).sendKeys("1234fds567890");
